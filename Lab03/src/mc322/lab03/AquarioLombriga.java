...
public class AquarioLombriga {
    ...
    AquarioLombriga(int lombriga, int aquario, int posicaoInicial){
        ...
        //diminui a lombriga para caber desde a posição incial até o fim do aquário
        if (posicaoFinal>=aquario){
            posicaoFinal=aquario-1;
            this.lombriga = aquario-posicaoFinal;
        }
